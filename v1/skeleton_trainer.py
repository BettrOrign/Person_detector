...
# ====== PROCESS ======
def cmd_process(data_root: str) -> None:
...
# ====== TRAIN ======
def cmd_train(seq_len=SEQUENCE_LENGTH):
    ...
    dataset = SkeletonDataset(DATA_DIR, classes, seq_len, augment=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seq-len', type=int, default=SEQUENCE_LENGTH,
                        help='Длина последовательности для обучения (default: 30)')
